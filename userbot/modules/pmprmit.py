...
DEF_UNAPPROVED_MSG = (
    ...
    "**╰━━━━━━━━━━━━━━━━━╯**\n"
    "───────────────────────────\n"
    f"**ANAK KONTOL ANAK KONTOL,KALO NGECHAT TUAN {DEFAULTUSER} ITU SALAM DULU LAH**\n"
    "───────────────────────────\n"
    "╭✠╼━━━━━━❖━━━━━━━✠╮\n"
    "┣[• 𝐁𝐎𝐓 𝐌𝐄𝐒𝐒𝐀𝐆𝐄\n"
    "┣[• 𝐁𝐘 💢JES-UBOT💢\n"
...
async def approvepm(apprvpm):
    ...
    await apprvpm.edit(f"`Baik` [{name0}](tg://user?id={uid}) `Pesan Lu udah di terima ya kontol`")
    ...
    if event.is_private:
        if not pm_permit_sql.is_approved(chats.id):
            pm_permit_sql.approve(
                chats.id, f"`TUAN KU ARMAN TELAH MENGIRIM PESAN UNTUK ANDA 😯`")
