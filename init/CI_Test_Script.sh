...
tg_sendinfo "<code>I am gonna merge staging into JESS-UBOT</code>"
cd
...
git push --force origin staging:JESS-UBOT
tg_sendinfo "<code>I have merged all commits from staging into JESS-UBOT</code>"
